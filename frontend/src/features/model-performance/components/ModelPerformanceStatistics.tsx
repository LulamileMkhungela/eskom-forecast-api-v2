...
/** MOCK unused. Live KPIs are ModelPerformanceKPIs → GET /api/forecast-metrics. Uncomment/import only after DE confirms this card set is needed (it duplicates live RMSE/MAE). */
